...
if (!defined('RANDOM_BONUS_CARDS_OPTION')) { // guard since this included multiple times
    ...
    define('CUBE_COLORS', [
        ...
        CUBE_COLOR_TEAL => ['name' => 'TEAL', 'colorCode' => 'a7d2b8'],
    ...
    define('BONUS_CARD_LARGEST_TEAL', 2);
    ...
    define('BONUS_CARD_LARGER_RIGHT_TEAL', 7);
    ...
    define('BONUS_CARDS_DATA', [
        ...
        BONUS_CARD_LARGEST_TEAL => ['id' => BONUS_CARD_LARGEST_TEAL, 'statName' => 'player_bonus_card_largest_teal', 'tooltip_text' => _('5 bonus points for the *largest group of teal cubes*')],
        ...
        BONUS_CARD_LARGER_RIGHT_TEAL => ['id' => BONUS_CARD_LARGER_RIGHT_TEAL, 'statName' => 'player_bonus_card_larger_right_teal', 'tooltip_text' => _('5 bonus points for having the *larger group of teal cubes* compared to your neighbor on your *right* ${rightPlayer}')],
